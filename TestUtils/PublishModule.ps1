...
try {
	...
	ExpandFile "$PSScriptRoot\TestUtils.psd1t" "$PSScriptRoot\PublishMacros.psd1" "$StagingDir\$PublishName.psd1"
	Copy-Item "$PSScriptRoot\TestUtils.psm1" "$StagingDir\$PublishName.psm1"
